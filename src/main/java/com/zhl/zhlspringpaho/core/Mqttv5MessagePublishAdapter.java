...
public class Mqttv5MessagePublishAdapter extends AbstractMqttMessageHandler
		implements MqttCallback, MqttComponent<MqttConnectionOptions>, ApplicationListener<ContextRefreshedEvent> {
	...
	public Mqttv5MessagePublishAdapter(String url, String clientId) {
		super(url, clientId);
	...
	public Mqttv5MessagePublishAdapter(MqttConnectionOptions connectionOptions, String clientId) {
	...
	public void publishMessage(String topic, Object mqttMessage, Message<?> message){
