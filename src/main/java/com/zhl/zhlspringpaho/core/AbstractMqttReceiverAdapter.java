 ...
 * @since 4.0
 */
public abstract class AbstractMqttReceiverAdapter
        implements ApplicationEventPublisherAware, ApplicationListener<ContextRefreshedEvent>, InitializingBean, BeanFactoryAware {
    ...
    public AbstractMqttReceiverAdapter(@Nullable String url, String clientId, String... topic) {
